...
function generateLoremIpsum() {
  ...
  // inputBox.innerHTML = generatedText.slice(0, -1);
  
}

//create JavaScript code for creating lorem ipsum generator using an API with asking a number of words from the user
